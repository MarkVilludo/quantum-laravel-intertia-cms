...
<template>
    ...
    >
        ...
        <!-- content -->
        <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0 justify-center">
            <div class="w-full mx-auto bg-white shadow-md rounded-lg overflow-hidden flex flex-col sm:max-w-md px-6 py-4">
                <h1 class="text-2xl font-bold text-center text-gray-800 mb-6">
                    Welcome to the Quantum App CMS!
                </h1>
