    ...
    public function run(): void
    {
        ...
        $courses = [
            [
                ...
                'level_id' => 1, // Replace with the actual level ID for Beginner
            ],
            [
            ...
            [
                ...
                'level_id' => 2, // Replace with the actual level ID for Intermediate
            ],
            [
            ...
            [
                ...
                'level_id' => 3, // Replace with the actual level ID for Advanced (if applicable)
            ],
            [
